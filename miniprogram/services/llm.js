...
const FALLBACK_RECIPE_STEPS = {
  '番茄炒蛋': {
    ...
    coverEmoji: '🍳',
    steps: [
      { title: '备菜', desc: '番茄洗净切小块，鸡蛋打入碗中加少许盐搅匀。', timer: 0 },
      { title: '炒蛋', desc: '热锅倒油，油温七成热时倒入蛋液，快速翻炒至凝固后盛出备用。', timer: 120 },
      { title: '炒番茄', desc: '锅中再加少许油，倒入番茄块翻炒，加半勺糖帮助出汁。', timer: 180 },
      { title: '合炒', desc: '番茄出汁后将炒好的鸡蛋倒回锅中，翻炒均匀，加盐调味。', timer: 60 },
      { title: '出锅', desc: '撒上葱花点缀（可选），盛盘上桌。', timer: 0 },
    ],
  ...
  '蒜蓉炒青菜': {
    ...
    coverEmoji: '🥬',
    steps: [
      { title: '备菜', desc: '青菜洗净沥干，大蒜切成蒜末备用。', timer: 0 },
      { title: '爆香', desc: '热锅倒油，放入蒜末小火煸炒出香味（注意不要炒糊）。', timer: 30 },
      { title: '炒青菜', desc: '转大火，倒入青菜快速翻炒，加适量盐。', timer: 180 },
      { title: '调味出锅', desc: '青菜变软变色后，加少许蚝油（可选），翻炒均匀即可出锅。', timer: 30 },
    ],
  ...
  '煎鸡蛋': {
    ...
    coverEmoji: '🍳',
    steps: [
      { title: '热锅', desc: '平底锅中小火烧热，倒入少许油，晃动锅子让油铺满锅底。', timer: 30 },
      { title: '打蛋', desc: '将鸡蛋打入锅中，保持中小火，让蛋白慢慢凝固。', timer: 0 },
      { title: '煎制', desc: '根据喜好：单面煎（只煎一面，蛋黄流心）或翻面煎（全熟）。撒少许盐和黑胡椒。', timer: 180 },
      { title: '出锅', desc: '用锅铲轻轻铲起，盛盘。可以搭配面包或米饭。', timer: 0 },
    ],
...
const generateGenericSteps = (recipeName, ingredients) => {
  return {
    ...
    coverEmoji: '🍽️',
    steps: [
      { title: '准备食材', desc: `将 ${ingredients.join('、')} 洗净切好，准备好调料（盐、生抽、油等）。`, timer: 0 },
      { title: '烹饪', desc: '热锅倒油，按照食材易熟程度依次下锅翻炒。', timer: 300 },
      { title: '调味', desc: '加入适量盐、生抽等调味，翻炒均匀。', timer: 60 },
      { title: '出锅装盘', desc: '起锅盛盘，完成！', timer: 0 },
    ],
